...
static void set_pmic_rank1(void)
{

	env_set("i2c_set_port", "i2c dev 4");
	env_set("variable1", "i2c mw 0x33 0xFA 0xD9 1");
	env_set("variable2", "i2c mw 0x33 0xFB 0x16 1");
	env_set("variable3", "i2c mw 0x33 0xF9 0x96 1");
	env_set("variable4", "i2c mw 0x33 0xFC 0xDE 1");
	env_set("variable5", "i2c mw 0x33 0xFE 0x0A 1");
	env_set("variable6", "i2c mw 0x33 0xFD 0xB8 1");
	env_set("variable7", "i2c mw 0x33 0xB9 0x01 1");
	// env_set("variable8", "i2c md 0x33 0xB8 1");
	env_set("variable8", "i2c mw 0x33 0xB9 0x10 1");
	// env_set("variable10", "i2c md 0x33 0xB8 1");
	env_set("variable9", "i2c md 0x33 0xFA 1");
	env_set("variable10", "i2c md 0x33 0xFB 1");
	env_set("variable11", "i2c md 0x33 0xFE 1");
	env_set("variable12", "i2c md 0x33 0xFC 1");
	env_set("variable13", "i2c md 0x33 0xFD 1");


	env_set("variable14", "reset");
	env_set("set_pmic_rank1", "run i2c_set_port variable1 variable2 variable3 variable4 variable5 variable6 variable7 variable8 variable9 variable10 variable11 variable12 variable13 variable14");
}
